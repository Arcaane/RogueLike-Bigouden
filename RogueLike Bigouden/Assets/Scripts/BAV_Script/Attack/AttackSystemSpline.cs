...
public class AttackSystemSpline : MonoBehaviour
{
    ...
    public Vector3 GetPoint(float t, Vector3[] pointsAttack)
    {
        ...
        return transform.TransformPoint(Bezier.GetPoint(
            new Vector3(pointsAttack[i].x * radiusAttack, 0, pointsAttack[i].z * radiusAttack),
            new Vector3(pointsAttack[i + 1].x * radiusAttack, 0, pointsAttack[i + 1].z * radiusAttack),
            new Vector3(pointsAttack[i + 2].x * radiusAttack, 0, pointsAttack[i + 2].z * radiusAttack),
            new Vector3(pointsAttack[i + 3].x * radiusAttack, 0, pointsAttack[i + 3].z * radiusAttack),
            t));
    }
